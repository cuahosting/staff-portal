...
import TimeSlotsSettings from "./time-slots/time-slots";
import LectureDaysSettings from "./lecture-days/lecture-days";
        ...
        <div className="d-flex flex-column flex-row-fluid">
            ...
            <div id="kt_content_container" className="container-custom container-xxl d-flex flex-column-fluid">
                <div className="pt-0 pb-0">
                    <ul className="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                        ...
                        <li className="nav-item mt-2">
                            <a className="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab" href="#kt_tabs_tab_4">Time Slots</a>
                        </li>
                        <li className="nav-item mt-2">
                            <a className="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab" href="#kt_tabs_tab_5">Lecture Days</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div className="flex-column-fluid">
                <div className="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}" data-kt-scroll-height="auto" data-kt-scroll-offset="70px">
                    ...
                    <div className="tab-pane fade" id="kt_tabs_tab_3">
                        <VenueSettings campusList={campusList} BlockList={BlockList} getData={getData} LoginDetails={props.LoginDetails} />
                    </div>
                    <div className="tab-pane fade" id="kt_tabs_tab_4">
                        <TimeSlotsSettings />
                    </div>
                    <div className="tab-pane fade" id="kt_tabs_tab_5">
                        <LectureDaysSettings />
                    </div>
                </div>
            </div>
