...
function CollegeModeration(props) {
    ...
    const applyModeration = async () => {
        ...
        const { success, data } = await api.post("staff/assessment/moderation/apply", {
            moduleCode: selectedModule.value, semester: selectedSemester.value, moderationType: "COLLEGE", mode,
        ...
        if (success && data.message === 'success') {
            toast.success(`Moderation applied to ${data.studentsModerated} students. ${data.requiresApproval ? 'Awaiting SBC approval.' : ''}`);
            loadStudents();
    ...
    return isLoading ? <Loader /> : (
        <div className="d-flex flex-column flex-row-fluid">
            <PageHeader title="College Moderation" items={["Assessment", "Moderation", "College"]} />
                            ...
                            <table className="table table-hover table-striped">
                                ...
                                <tbody>
                                    {students.map((student, index) => {
                                        ...
                                        return (
                                            <tr key={student.EntryID} className={isFiltered ? 'table-info' : ''}>
...
export default connect(mapStateToProps, null)(CollegeModeration);
