        ...
        await axios.post(`${serverLink}staff/student-manager/enrolment-details`, { studentID: studentID }, token)
            .then((result) => {
                if (result.data.length > 0) {
                    ...
                    let department_code = course.filter(e=>e.CourseCode === data.CourseCode)[0].DepartmentCode
                    setDepartmentCode(department_code)
                    setData(result.data[0]);
                    setFaculty(departments.filter(x => x.DepartmentCode === department_code)[0].FacultyCode)
                    ...
                    <div className="card-body pt-9 pb-0">
                        <div className={`d-flex justify-content-end p-6`}>
                            <div className="d-flex flex-stack">
                                <Link className='' style={{ float: 'right' }} to='/registration/student-manager/enrolment/report'>Enrolment List</Link>
                            </div>
                        </div>
                        ...
                        <div className="d-flex flex-wrap flex-sm-nowrap mb-3">
                            <div className="me-7 mb-4">
                                <div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    {passport !== '' && <img src={passport.includes("simplefileupload") ? passport : `${serverLink}public/uploads/${shortCode}/application/document/${passport}`} alt="image" />}
                                </div>
                            </div>
                                                    ...
                                                    <div className="fs-2 fw-bolder">
                                                        {
                                                            departmentList.filter(
                                                                x => x.DepartmentCode.toLowerCase() === departmentCode.toLowerCase())[0].DepartmentName
                                                        }
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <ul className="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            ...
                            <li className="nav-item mt-2">
                                <a className="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab" href="#kt_results">Result</a>
                            </li>
                            <li className="nav-item mt-2">
                ...
                <div className="row col-md-12 flex-column-fluid">
                    ...
                    >
                        ...
                        <div
                            ...
                            id="kt_results">
                            <div className="flex-column-fluid">
                                <div className="card mb-5 mb-xl-10" id="kt_results">
                                    <div className="card-header card-header-stretch">
                                        <div className="card-title">
                                            <h3 className="m-0 text-gray-800">Modules Result</h3>
                                        </div>
                                    </div>
                                    <div className="col-md-12" style={{ width: '100%' }}>
                                        <div className="card-body p-9">
                                            <div className="col-md-12" >
                                                <div className="row" style={{ width: '100%' }}>
                                                    <ReportTable columns={res_columns} data={resultList} title={'Module Results'} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                documents.map((x, y) => {
                                                    return (
                                                        <div className="row mb-7" key={y}>
                                                            ...
                                                            <div className="col-lg-9">
                                                                <a target={'_blank'} href={x.FileName.includes("simplefileupload") ? x.FileName : 
                                                                `${serverLink}public/uploads/${shortCode}/application/document/${x.FileName}`}>View Document</a>
                                                            </div>
                                                        </div>
                                                    )
                                                })
