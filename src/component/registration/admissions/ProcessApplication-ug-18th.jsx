              ...
              .then((result) =>
              {
                ...
                )
                {
                  ...
                  admissionEmail(
                    ...
                    `<br />We are happy to inform you that you have been given provisional admission into ${projectName.split('|')[0]}.<br/>
                    Provisional admission means that While you have met some of the requirements for admission into ${shortCode}, you have not met all the requirements for the admission into ${shortCode}.<br/>
                    Of the listed items below, the checked-marked one(s) is/are the requirement(s) for you to be fully admitted into ${shortCode}.
                    <ol>
                    ${checked}
                    </ol><br/>
                    You have one month period of time within which to provide ${shortCode} with the above indicated item(s), failing which, your admission into ${shortCode} may be postpone to another semester, academic year or rescinded altogether.<br/>
                    We look forward to you completing your admission requirements and joining OUB for your educational pursuits.<br />
                    
                    Kindly login to your <a href="https://www.oliviauniversity.edu.bi/admission/application/login">application portal</a> to download your admission letter.
                    <br/>
                    Best wishes!<br />&nbsp;<br/>
                    Registrar,<br/>
    ...
    <div className="d-flex flex-column flex-row-fluid">
      <div className="col-md-12">
        <div className="d-flex justify-content-end">
          {
            appInfo.course[0].AdmissionLetter !== "0" &&
            <a target={"_blank"} href={`${serverLink}public/uploads/${shortCode}/admission-letters/${appInfo.course[0].AdmissionLetter}.pdf`} className="btn btn-sm btn-primary">Print Admission Letter</a>
          }
        </div>
