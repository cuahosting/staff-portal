      ...
      <div className="col-md-12">
        ...
        <div className="col-md-12"><div className="row">
          <form onSubmit={handleSubmit}>
            ...
            <div className="d-flex flex-column mb-8 mt-8"><button disabled={shortCode === "AUM" ? false : Statuscolor !== "info"} type="submit" className={`btn btn-${Statuscolor !== "info" ? Statuscolor : "primary"} mt-4`}>{shortCode === "AUM" ? "Submit" : Statuscolor !== "info" ? Statustext : "Submit"}</button></div>
          </form>
        </div></div>
      </div>
