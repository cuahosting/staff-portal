...
function LibraryClearance(props) {
  ...
  async function TakeDecision(decision, id) {
    const dataTo={
      ...
      ClearedBy: 'LibraryClearedBy' ,
      insertedBy:props.loginData.StaffID,
      ClearedDate:'LibraryClearedDate',
    }
    await axios
  ...
  const getClearance = async () => {
    await axios
      .get(`${serverLink}staff/users/graduation-clearance/library`, token)
      .then((res) => {
        const data = res.data;
        let rows = [];
              ...
              rows.push([
                ...
                <>
                  <button
                    ...
                    title="Cleared"
                    onClick={() => {
                      if (item.LibraryCleared !== "Cleared") {
                  ...
                  <button
                    ...
                    data-toggle="tooltip"
                    onClick={() => {
                      if (item.LibraryCleared !== "Rejected") {
  ...
  return isLoading ? (
    ...
    <div className="d-flex flex-column flex-row-fluid">
      <PageHeader
        ...
        items={["Users", "Graduation Clearance", "Library Clearacne"]}
      />
