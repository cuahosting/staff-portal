...
function PaymentByLevel(props) {
    ...
    const getReportData = async () => {
        ...
        const result = await api.get(
            `staff/ac-finance/reports/payment-by-level?semester=${selectedSemester}`,
            token
        );
    ...
    const buildTable = (data) => {
        ...
        data.forEach((item) => {
            ...
            rows.push({
                Level: <span className="fw-bold">{item.Level || item.LevelName}</span>,
    ...
    const calculateStats = (data) => {
        ...
        setSummaryStats({
            ...
            collectionRate: totals.billed > 0
                ? ((totals.paid / totals.billed) * 100).toFixed(1)
                : 0,
        });
    };
    ...
    const exportToCSV = () => {
        ...
        const headers = ["Level", "Students", "Total Billed", "Total Paid", "Outstanding", "Collection Rate"];
        ...
        a.href = url;
        a.download = `payment_by_level_${selectedSemester}_${new Date().toISOString().split("T")[0]}.csv`;
        a.click();
    ...
    return isLoading ? (
        ...
        <div className="d-flex flex-column flex-row-fluid">
            <PageHeader
                title="Payment Report by Level"
                items={["Human Resources", "AC-Finance", "Reports", "By Level"]}
            />
                    ...
                    <>
                        ...
                        <div className="card">
                            <div className="card-header border-0 pt-5">
                                <h3 className="card-title">Payment Summary by Level</h3>
                            </div>
...
export default connect(mapStateToProps, null)(PaymentByLevel);
