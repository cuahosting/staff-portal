...
function PaymentByDepartment(props) {
    ...
    const getReportData = async () => {
        ...
        const result = await api.get(
            `staff/ac-finance/reports/payment-by-department?semester=${selectedSemester}`,
            token
        );
    ...
    const buildTable = (data) => {
        ...
        data.forEach((item, index) => {
            ...
            rows.push({
                sn: index + 1,
                Department: <span className="fw-bold">{item.DepartmentName}</span>,
                Faculty: (
    ...
    const exportToCSV = () => {
        ...
        const headers = ["Department", "Faculty", "Students", "Total Billed", "Total Paid", "Outstanding", "Collection Rate"];
        ...
        a.href = url;
        a.download = `payment_by_department_${selectedSemester}_${new Date().toISOString().split("T")[0]}.csv`;
        a.click();
    ...
    return isLoading ? (
        ...
        <div className="d-flex flex-column flex-row-fluid">
            <PageHeader
                title="Payment Report by Department"
                items={["Human Resources", "AC-Finance", "Reports", "By Department"]}
            />
                    ...
                    <>
                                        ...
                                        <div className="d-flex align-items-center">
                                            <div className="symbol symbol-50px me-3">
                                                <span className="symbol-label bg-primary">
                                                    <i className="fa fa-building text-white fs-3"></i>
                                                </span>
                                            </div>
                                            <div>
                                                <div className="fs-4 fw-bold">{summaryStats.totalDepartments}</div>
                        ...
                        <div className="card">
                            <div className="card-header border-0 pt-5">
                                <h3 className="card-title">Payment Summary by Department</h3>
                            </div>
...
export default connect(mapStateToProps, null)(PaymentByDepartment);
