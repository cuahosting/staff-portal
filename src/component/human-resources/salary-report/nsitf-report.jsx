...
function NSITFReport(props) {
    ...
    const header = ["S/N", "Staff ID", "Staff Name", "Date of Birth", "Gender", "Monthly Earnings (₦)", "NSITF Amount", "Remarks"];
                        ...
                        <div className="mt-4">
                            {reportData.length > 0 &&
                                <div className="table-responsive">
                                    <DataTable header={header} body={showTable()} title="NSITF Schedule Report"/>
                                </div>
                            }
                        </div>
                    }
