...
function LaundryPaymentReport(props) {
    ...
    const handleChange = async (semesterCode) => {
        ...
        try {
            ...
            const { success, data: result } = await api.get(
                `staff/human-resources/finance-report/laundry-payment-report?semester=${semesterCode}`
            );
            ...
            if (success) {
                if (result.data && result.data.length > 0) {
                    ...
                    toast.info("No laundry payments found for this semester");
                        ...
                        {canSeeReport && (
                            <div className="row mt-5">
                                <div className="col-md-12">
                                    ...
                                    <ReportTable
                                        title={`Laundry Payment Report - ${selectedSemester}`}
                                        columns={columns}
                                        data={data}
                                        height={tableHeight}
                                    />
...
export default connect(mapStateToProps, null)(LaundryPaymentReport);
