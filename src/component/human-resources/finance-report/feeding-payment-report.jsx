...
function FeedingPaymentReport(props) {
    ...
    const handleChange = async (semesterCode) => {
        ...
        try {
            ...
            const { success, data: result } = await api.get(
                `staff/human-resources/finance-report/feeding-payment-report?semester=${semesterCode}`
            );
            ...
            if (success) {
                if (result.data && result.data.length > 0) {
                    ...
                    toast.info("No feeding payments found for this semester");
...
export default connect(mapStateToProps, null)(FeedingPaymentReport);
